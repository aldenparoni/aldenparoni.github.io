...
<div class="text-center">
    <img class="py-2" src="../img/mmm-title-screen.png" alt="Mars Mech Mission title screen">
</div>
...
<img src="../img/mmm-in-game.png" class="rounded float-start pe-4" width="650px" alt="Mars Mech Mission gameplay screenshot">
